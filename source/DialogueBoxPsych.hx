...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		box.animation.addByPrefix('normal', 'dialogue0', 24);
		box.animation.addByPrefix('normalOpen', 'dialogue0', 24, false);
		box.animation.addByPrefix('angry', 'dialogue scream', 24);
		box.animation.addByPrefix('angryOpen', 'dialogue scream', 24, false);
		box.animation.addByPrefix('center-normal', 'dialogue0', 24);
		box.animation.addByPrefix('center-normalOpen', 'dialogue0', 24, false);
		box.animation.addByPrefix('center-angry', 'dialogue scream', 24);
		box.animation.addByPrefix('center-angryOpen', 'dialogue scream', 24, false);
